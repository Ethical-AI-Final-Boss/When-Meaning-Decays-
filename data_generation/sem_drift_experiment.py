...
from models_local import BACKEND_LABEL, LocalChatModel
...
DEFAULT_PROJECT_ROOT = Path(
    os.environ.get("PROJECT_ROOT", "/mnt/h200_raid5/name")
)
...
# /mnt/h200_raid5/name/outputs/semantic_drift_from_golden/model_name/*.csv
