...
INPUT_DESCRIPTIONS_CSV = "/mnt/h200_raid5/name/outputs/semantic_drift/golden_descriptions_gpt_oss.csv"

RUN_TIMESTAMP = datetime.now().strftime("%Y%m%d_%H%M%S")

OUTPUT_CSV = f"/mnt/h200_raid5/name/outputs/semantic_drift/golden_descriptions_guess_validation_{RUN_TIMESTAMP}.csv"
SUMMARY_CSV = f"/mnt/h200_raid5/name/outputs/semantic_drift/golden_descriptions_guess_validation_summary_{RUN_TIMESTAMP}.csv"
ERROR_CSV = f"/mnt/h200_raid5/name/logs/golden_descriptions_validation_errors_{RUN_TIMESTAMP}.csv"
